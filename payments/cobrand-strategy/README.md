...
IF revenue share or profit share model selected AND partner revenue share rate > 35% (indicative ceiling; above this level, issuer margin is typically insufficient to cover funding cost, credit losses, and overhead across most market structures)
...
**Scenario:** A regional Asia Pacific issuer evaluating a co-brand with a global mid-tier hotel loyalty program operating in a regulated interchange environment (Japan-style market).
...
| Revenue sharing model | Points purchase + acquisition bounty ($50/card) |
...
| Domestic interchange rate | ~0.9% (regulated environment) |
| Revolving rate | 12% |
| Annual card fee | $120 |
...
| R6 — Payback | ✅ Pass | $50 bounty ÷ ($120 fee + ~$43 interchange) = <6 months payback |
